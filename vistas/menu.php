    ...
    <div class="navbar navbar-inverse navbar-fixed-top" data-spy="affix" data-offset-top="100">
      <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          ...
          <li class="dropdown">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><span class="glyphicon glyphicon-list-alt"></span> Administrar Productor <span class="caret"></span></a>
            <ul class="dropdown-menu">
              <li><a href="categorias.php">Tipo de Producto</a></li>
...
<H1 class="text-center">DIPLOMADO DE ACTUALIZACIÓN Y PROFUNDIZACIÓN </H1>
<H2 class="text-center">PROYECTO MÓDULO DE  METODOLOGÍAS ÁGILES </H2>
<H3 class="text-center">Docente Ing Elicer Suarez </H3>
